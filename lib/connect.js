...
function wrapComponent(Component, options) {
  ...
  return function (ctx) {
    var wrappedProps = _objectSpread({}, props);

    if (ctx) {
      var storeState = ctx.storeState,
          store = ctx.store;
      wrappedProps = _objectSpread({}, mapStateToProps(storeState, wrappedProps), mapActionsToProps(store.actions, wrappedProps), wrappedProps);
    }
...
function connect(mapStateToProps, mapActionsToProps, context) {
  var ContextToUse = context || _context.default;
    ...
    return function (_React$Component) {
      ...
      _createClass(_class, [{
        ...
        value: function render() {
          ...
          return React.createElement(ContextToUse.Consumer, null, WrappedComponent);
        }
      }]);
